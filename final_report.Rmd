...
This graph is obtained using the 1921-2021 songs data. 
...
#### **Justin Park**
Justing worked on the questions "What are the most popular genres?" and "Who are the most popular artists?". He also helped with putting together the final report and presentation.
...
In addition to the finalized code above, Mario helped with data aquisition, proposal brainstorming, presentation slides, final report, and the final presentation.
